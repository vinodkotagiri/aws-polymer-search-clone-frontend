		...
		<nav className='w-screen h-14 shadow-md flex items-center gap-2 bg-white sticky top-0 left-0'>
			...
			<div className='hidden md:flex items-center justify-between flex-1 mr-6'>
				...
				<div className='md:flex gap-6 font-semibold text-sm hidden relative'>
					<button className='border-2 px-6 pl-2 rounded-lg py-2  flex gap-1 items-center text-blue-600 hover:bg-blue-600 hover:text-black hover:outline-none hover:border-none'>
						<img src={animatedIcons} alt='logo' className='h-5 animate-pulse duration-300 rounded-full' />
						More Sites
					</button>
					<button className='outline-none px-4 pl-2 rounded-lg py-2 flex gap-1 items-center text-white bg-blue-600 hover:bg-black' onClick={()=>window.open('https://www.polymersearch.com/','_blank')}>
			...
			{isRightMenuVisibe && (
				<div className='flex flex-col absolute top-0 right-0 h-screen bg-white py-16 px-1 pr-3'>
					...
					<button className=' px-4 pl-2 rounded-lg py-2 outline-none flex gap-1 items-center text-white bg-blue-600 hover:bg-black' onClick={()=>window.open('https://www.polymersearch.com/','_blank')}>
						<img src={animatedPolymerLogo} alt='logo' className='h-5' />
						Built with Polymer
					</button>
				</div>
